...
public:
	...
	void SetCamera( const vecteur3d& v1,
							   const vecteur3d& v2,
							   const vecteur3d& v3 );
	camera getleviathan() const;
	void SetCameraPosition();
	void SetCameraPosition( const vecteur3d& v );
	void SetCameraRelativeAim();
	void SetCameraRelativeAim( const vecteur3d& v );
	void SetCameraAbsoluteAim();
	void SetCameraAbsoluteAim( const vecteur3d& v );
	void SetCameraVerticale();
	void SetCameraEx();
