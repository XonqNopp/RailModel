...
void dessinable::SetCamera( const vecteur3d& v1,
							   const vecteur3d& v2,
							   const vecteur3d& v3 )
{
	leviathan.setpos( v1 );
...
/*******************************************************************************/
void dessinable::SetCameraPosition() { leviathan.setpos(); }
void dessinable::SetCameraPosition( const vecteur3d& v ) { leviathan.setpos( v ); }
void dessinable::SetCameraRelativeAim() { leviathan.setvis(); }
void dessinable::SetCameraRelativeAim( const vecteur3d& v ) { leviathan.setvis( v ); }
void dessinable::SetCameraAbsoluteAim() { leviathan.juju(); }
void dessinable::SetCameraAbsoluteAim( const vecteur3d& v ) { leviathan.juju( v ); }
void dessinable::SetCameraVerticale() { leviathan.setver(); }
void dessinable::SetCameraEx() { leviathan.setex(); }
void dessinable::SetCameraRadius() { leviathan.laser(); }
